...
def load_all_data_source_files():
    """
    ...
    try:
        for source_name, source_config in DATA_SOURCES.items():
            ...
            for dataset in source_config["datasets"]:
                ...
                primary_keys = dataset["primary_key"]
                ...
                for parquet_file in objects:
                    ...
                    try:
                        ...
                        cursor.execute(
                            ...
                            SELECT {columns}
                            FROM public.stg_{table_name}
                            ON CONFLICT ({", ".join(primary_keys)}) DO NOTHING;
                            """
                        )

                        cursor.execute(f"TRUNCATE TABLE public.stg_{table_name};")
